...
public class EmployeeController {
    ...
    @GetMapping("/{id}")
    @ResponseStatus(HttpStatus.OK)
    public Employee getOneEmployee(@PathVariable(name = "id") long id) throws SQLException {
    ...
    @PutMapping("/{id}")
    @ResponseStatus(HttpStatus.CREATED)
    public Employee updateEmployee(@PathVariable (name = "id") long id, @RequestBody Employee employee) throws SQLException {
    ...
    @DeleteMapping("/{id}")
    @ResponseStatus(HttpStatus.OK)
    public Employee deleteEmployee(@PathVariable (name = "id") long id) throws SQLException {
