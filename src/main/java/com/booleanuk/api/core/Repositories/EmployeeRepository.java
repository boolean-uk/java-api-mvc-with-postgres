...
public class EmployeeRepository {
    ...
    public List<Employee> getAll() throws SQLException {
        ...
        while (results.next()) {
            Employee employee = new Employee(results.getInt("id"), results.getString("name"), results.getString("jobName"), results.getString("salaryGrade"), results.getString("department"));
    ...
    public Employee getOne(long id) throws SQLException {
        ...
        Employee emp = null;
        if (results.next()) {
            emp = new Employee(results.getInt("id"), results.getString("name"), results.getString("jobName"), results.getString("salaryGrade"), results.getString("department"));
        }
        return emp;
    }

    public Employee editOne(int id, Employee emp) throws SQLException {
        ...
        statement.setString(2, emp.getJobName());
        statement.setString(3, emp.getSalaryGrade());
        statement.setString(4, emp.getDepartment());
        statement.setLong(5, id);
        int rowsAffected = statement.executeUpdate();
        Employee updatedEmp = null;
        if (rowsAffected > 0) {
            updatedEmp = this.getOne(id);
        }
        return updatedEmp;
    }
    ...
    public Employee addOne(Employee emp) throws SQLException {
