...
public class EmployeeRepository {
    ...
    public List<Employee> getAll() throws SQLException  {
        ...
        while (results.next()) {
            Employee theEmployee = new Employee(results.getInt("id"), results.getString("name"), results.getString("job_name"), results.getInt("salary_id"), results.getString("department_id"));
    ...
    public Employee get(int id) throws SQLException {
        ...
        if (results.next()) {
            employee = new Employee(results.getInt("id"), results.getString("name"), results.getString("job_name"), results.getInt("salary_id"), results.getString("department_id"));
        }
        return employee;
    }
