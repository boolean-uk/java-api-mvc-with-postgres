...
public class DepartmentRepository {
    ...
    public Department editOne(int id, Department department) throws SQLException {
    ...
    public Department addOne(Department department) throws SQLException {
